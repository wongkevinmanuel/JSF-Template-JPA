package com.personas.daoacc;

import com.model.Personas;
import com.personas.daoacc.util.JsfUtil;
import com.personas.daoacc.util.PaginationHelper;
import com.personas.cont.PersonasFacade;
...
public class PersonasController implements Serializable {
    ...
    @EJB
    private com.personas.cont.PersonasFacade ejbFacade;
    ...
    public String createK(){
        String resultado = null;
        try{
            getFacade().createK(current);
            FacesMessage facesMsg = new FacesMessage(FacesMessage.SEVERITY_INFO,"Persistio Persona","Se ingreso correctamente con JPA");
            FacesContext.getCurrentInstance().addMessage("successInfo", facesMsg);
        }
        catch(Exception e){
            FacesMessage facesMsg = new FacesMessage(FacesMessage.SEVERITY_ERROR,"No Persistio Persona","El ingreso FALLO ...");
